...
export const DICT = {
  ...
  "laneV2.revoke": { en: "Withdraw", zh: "收回" },
  "laneV2.revokeAsk": { en: "Withdraw?", zh: "确定收回?" },
  "laneV2.revokeLabel": { en: "Withdraw {name} from the AI", zh: "把 {name} 从 AI 那里收回" },
  ...
  "memory.planHead": { en: "PLAN", zh: "计划" },
  "memory.planCount": { en: "{done} of {n} done", zh: "{n} 步 · 完成 {done}" },
  "memory.planDoing": { en: "{n} in flight", zh: "在做 {n}" },
  "memory.planBlocked": { en: "{n} blocked", zh: "阻塞 {n}" },
  "memory.stepTodo": { en: "Not started", zh: "未开始" },
  "memory.stepDoing": { en: "In flight", zh: "在做" },
  "memory.stepBlocked": { en: "Blocked", zh: "阻塞" },
  "memory.stepDone": { en: "Done", zh: "完成" },
  "memory.stepTitleLabel": { en: "Step title", zh: "步骤标题" },
  "memory.stepEditOne": { en: "Edit step {n}", zh: "改第 {n} 步" },
  "memory.stepNoteHint": {
    en: "Why it is stuck, or what this step actually involves",
    zh: "为什么卡住,或者这一步实际上要做什么",
  },
  "memory.stepGone": {
    en: "Couldn't save: this plan has been rewritten, and that step is gone.",
    zh: "没能保存:这份计划已经被改写过,这一步不在了。",
  },
  "memory.stepSaveFailed": { en: "Couldn't save that change.", zh: "没能保存这处改动。" },
  "memory.stepReload": { en: "Reload", zh: "重新读取" },
  ...
  "memory.how.title": { en: "How the AI takes notes", zh: "AI 是怎么记笔记的" },
  "memory.how.you": { en: "You", zh: "你" },
  "memory.how.ai": { en: "AI", zh: "AI" },
  "memory.how.here": { en: "This page", zh: "这一页" },
  "memory.how.s1": { en: "Every conversation starts by reading what is here", zh: "每次对话开始,先读这里的内容" },
  "memory.how.s2": { en: "While working it writes down where it got to", zh: "工作中,把做到哪、定了什么写回来" },
  "memory.how.s3": { en: "Next time it picks up from here, not from zero", zh: "下一次从这里接着,不从零开始" },
  "memory.how.sayTitle": { en: "Things you can say", zh: "你可以这么说" },
  "memory.how.say1": { en: "Carry on from last time.", zh: "接着上次做。" },
  "memory.how.say2": { en: "Make a note of that.", zh: "记一下。" },
  "memory.how.say3": { en: "Have a look at this folder's memory first.", zh: "先看看这个目录的记忆。" },
  "memory.how.note": {
    en: "It writes on its own; nothing here goes into your project files. You can edit and delete on this page.",
    zh: "它自己会写;这里的内容不会写进你的项目文件。你可以在这一页改和删。",
  },
  "memory.how.ok": { en: "Got it", zh: "知道了" },
  "memory.noFolderBody": {
